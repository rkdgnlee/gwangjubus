...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 13, color: '#8B95A1', marginBottom: 4 },
  title: { fontSize: 20, fontWeight: '600', color: '#191F28' },
  ...
  provinceText: { fontSize: 15, color: '#4E5968', textAlign: 'center' },
  provinceTextActive: { color: '#191F28', fontWeight: 'bold' },
  activeIndicator: {
    position: 'absolute',
    left: 0, top: 15, bottom: 15,
    width: 4, backgroundColor: '#31D698',
    borderTopRightRadius: 4, borderBottomRightRadius: 4,
  },

  cityColumn: { flex: 1, backgroundColor: '#fff' },
  ...
  cityName: { flex: 1, fontSize: 15, color: '#191F28' },
  cityNameActive: { color: '#0F6E56', fontWeight: '600' },
  cityCheck: { fontSize: 16, color: '#31D698', fontWeight: 'bold' },

  emptyContainer: { paddingTop: 100, alignItems: 'center', paddingHorizontal: 20 },
  emptyText: { fontSize: 14, color: '#B0B8C1', textAlign: 'center', lineHeight: 20 },

  footer: { padding: 20, paddingBottom: 8, borderTopWidth: 1, borderTopColor: '#F2F4F6', backgroundColor: '#fff' },
  ...
  hintDotActive: { backgroundColor: '#31D698' },
  hintText: { fontSize: 13, color: '#8B95A1' },
  hintTextActive: { color: '#0F6E56', fontWeight: '500' },
  confirmButton: { backgroundColor: '#191F28', borderRadius: 14, padding: 18, alignItems: 'center' },
  confirmButtonDisabled: { opacity: 0.35 },
  confirmText: { fontSize: 15, fontWeight: '500', color: '#fff' },
});
